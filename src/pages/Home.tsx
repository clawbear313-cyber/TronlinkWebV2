    ...
    <main>
      ...
      >
        ...
        <div className="container-site hero-content w-full">
          <div ref={heroContentRef} style={{ maxWidth: '640px' }}>
            ...
            <h1 style={{ fontSize: 'clamp(2.5rem, 6vw, 4.5rem)', fontWeight: 700, marginBottom: '1.5rem', color: '#0f0e17' }}>
              將概念化為形體
            </h1>
            <p style={{ color: '#374151', fontSize: '1.0625rem', lineHeight: 1.75, maxWidth: '480px', marginBottom: '2.5rem' }}>
      ...
      <section className="section-pad" style={{ backgroundColor: '#f5f5ff' }}>
        <div className="container-site">
          ...
          <div ref={servicesRef} style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1px', backgroundColor: '#c7d2fe' }}>
            {SERVICES.map((svc) => (
              <div
                key={svc.id}
                style={{ backgroundColor: '#f5f5ff', padding: '2.5rem 2rem' }}
              >
                ...
                <p style={{ color: '#374151', fontSize: '0.8125rem', fontFamily: 'JetBrains Mono, monospace', marginBottom: '1rem' }}>{svc.nameEn}</p>
                <p style={{ color: '#374151', fontSize: '0.875rem', lineHeight: 1.7 }}>{svc.description[0]}</p>
                <Link
                  to="/services"
            ...
            {WORK_CASES.map((wc) => (
              ...
              >
                ...
                <div style={{ padding: '1.75rem' }}>
                  ...
                  <h3 style={{ fontSize: '1.125rem', fontWeight: 600, marginBottom: '0.25rem', color: '#0f0e17' }}>{wc.client}</h3>
                  <p style={{ color: '#374151', fontSize: '0.8125rem', fontFamily: 'JetBrains Mono, monospace', marginBottom: '0.875rem' }}>{wc.industry}</p>
                  <p style={{ color: '#374151', fontSize: '0.875rem', lineHeight: 1.65 }}>{wc.outcome}</p>
                </div>
              </article>
            ))}
          </div>
      ...
      <section style={{ backgroundColor: '#f5f5ff', borderTop: '1px solid #c7d2fe', borderBottom: '1px solid #c7d2fe' }}>
        <div className="container-site" style={{ paddingTop: '5rem', paddingBottom: '5rem', textAlign: 'center' }}>
          <Reveal>
            ...
            <p style={{ color: '#374151', fontSize: '1rem', marginBottom: '2.5rem' }}>讓我們一起討論您的下一個專案。</p>
