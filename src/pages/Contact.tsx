          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '5rem', alignItems: 'start' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem' }}>
                <div>
                  ...
                  <a
                    ...
                    style={{ color: '#d97706', fontSize: '1rem', fontWeight: 500, fontFamily: 'JetBrains Mono, monospace' }}
                  >
                    hello@tronlix.com
                  </a>
                </div>
                <div>
                  ...
                  <p style={{ color: '#a8a29e', fontSize: '0.9375rem' }}>Taipei, Taiwan</p>
                </div>
                <div>
            ...
            <Reveal delay={0.15}>
              {submitted ? (
                ...
                >
                  <p style={{ color: '#d97706', fontFamily: 'JetBrains Mono, monospace', fontSize: '0.75rem', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '1rem' }}>
                    Message sent
                  </p>
                  <h2 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.75rem' }}>感謝您的訊息</h2>
                  <p style={{ color: '#a8a29e', fontSize: '0.9375rem' }}>我們會在 24 小時內回覆。</p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} noValidate style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                  {[
                    ...
                    <div key={id} style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                      <label htmlFor={id} style={{ color: '#a8a29e', fontSize: '0.8125rem', fontWeight: 500, letterSpacing: '0.04em' }}>
                        {label}
                      </label>
                      <input
                        id={id}
                        ...
                        onBlur={(e) => (e.currentTarget.style.borderColor = '#44403c')}
                      />
                    </div>
                  ))}
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                    <label htmlFor="details" style={{ color: '#a8a29e', fontSize: '0.8125rem', fontWeight: 500, letterSpacing: '0.04em' }}>
                      Project Details
                    </label>
                    <textarea
                      id="details"
