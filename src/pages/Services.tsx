                ...
                >
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '3rem' }}>
                    ...
                    <div>
                      ...
                      <p style={{ color: '#374151', fontFamily: 'JetBrains Mono, monospace', fontSize: '0.8125rem', marginBottom: '1.5rem' }}>{svc.nameEn}</p>
                      {svc.description.map((d, di) => (
                        <p key={di} style={{ color: '#374151', lineHeight: 1.75, fontSize: '0.9375rem', marginBottom: di < svc.description.length - 1 ? '1rem' : 0 }}>{d}</p>
                      ))}
                      <p style={{ marginTop: '1.5rem', color: '#374151', fontSize: '0.8125rem', lineHeight: 1.65 }}>
