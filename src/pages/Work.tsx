          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0' }}>
            {WORK_CASES.map((wc, i) => (
              <Reveal key={wc.id} delay={i * 0.1}>
                <article style={{ borderTop: '1px solid #c7d2fe', paddingTop: '4rem', paddingBottom: '4rem' }}>
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '3rem', alignItems: 'start' }}>
                    ...
                    <div>
                      ...
                      <p style={{ color: '#374151', fontFamily: 'JetBrains Mono, monospace', fontSize: '0.8125rem', marginBottom: '2rem' }}>{wc.industry}</p>
                      ...
                      <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '1.25rem' }}>
                        {[
                          ...
                          <div key={label}>
                            ...
                            <p style={{ color: '#374151', fontSize: '0.875rem', lineHeight: 1.7 }}>{text}</p>
                          </div>
                        ))}
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      />
                      <div style={{ backgroundColor: '#eef2ff', border: '1px solid #c7d2fe', borderRadius: '0.25rem', padding: '1.5rem' }}>
                        <p className="label-tag" style={{ marginBottom: '0.75rem' }}>Outcome</p>
                        <p style={{ color: '#0f0e17', fontWeight: 500, lineHeight: 1.65 }}>{wc.outcome}</p>
                      </div>
                    </div>
                  </div>
                </article>
