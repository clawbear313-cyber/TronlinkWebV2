          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0' }}>
            {WORK_CASES.map((wc, i) => (
              <Reveal key={wc.id} delay={i * 0.1}>
                <article style={{ borderTop: '1px solid #44403c', paddingTop: '4rem', paddingBottom: '4rem' }}>
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '3rem', alignItems: 'start' }}>
                    ...
                    <div>
                      ...
                      <p style={{ color: '#a8a29e', fontFamily: 'JetBrains Mono, monospace', fontSize: '0.8125rem', marginBottom: '2rem' }}>{wc.industry}</p>
                      ...
                      <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '1.25rem' }}>
                        {[
                          ...
                          <div key={label}>
                            ...
                            <p style={{ color: '#a8a29e', fontSize: '0.875rem', lineHeight: 1.7 }}>{text}</p>
                          </div>
                        ))}
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      />
                      <div style={{ backgroundColor: '#3c3836', border: '1px solid #44403c', borderRadius: '0.25rem', padding: '1.5rem' }}>
                        <p className="label-tag" style={{ marginBottom: '0.75rem' }}>Outcome</p>
                        <p style={{ color: '#fafaf9', fontWeight: 500, lineHeight: 1.65 }}>{wc.outcome}</p>
                      </div>
                    </div>
                  </div>
                </article>
