      ...
      >
        ...
        <div className="container-site hero-content w-full">
          <Reveal>
            ...
            <p style={{ color: '#374151', fontSize: '1.0625rem', maxWidth: '480px' }}>
            ...
            {PROCESS_STEPS.map((step, i) => (
              <div
                ...
                style={{
                  ...
                  gap: '2rem',
                  padding: '2.5rem 0',
                  borderBottom: i < PROCESS_STEPS.length - 1 ? '1px solid #c7d2fe' : 'none',
                  alignItems: 'start',
                }}
              >
                <div>
                ...
                <div>
                  <h2 style={{ fontSize: '1.25rem', fontWeight: 600, marginBottom: '0.375rem', color: '#0f0e17' }}>
                    {step.titleZh}
                  </h2>
                  <p style={{ color: '#374151', fontFamily: 'JetBrains Mono, monospace', fontSize: '0.8125rem', marginBottom: '0.875rem' }}>
                    {step.titleEn}
                  </p>
                  <p style={{ color: '#374151', lineHeight: 1.7, fontSize: '0.9375rem', maxWidth: '560px' }}>
                    {step.desc}
                  </p>
                </div>
              </div>
